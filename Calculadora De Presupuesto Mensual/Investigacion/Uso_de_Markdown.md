...
texto utilizando una sintaxis simple y fácil de leer. Fue diseñado para
que el contenido pueda escribirse en texto plano y convertirse
rápidamente en HTML u otros formatos.

Su objetivo principal es permitir crear documentos estructurados sin
usar herramientas complejas de edición.

------------------------------------------------------------------------

# ¿Por qué se usa Markdown en proyectos de software?

Markdown es ampliamente usado en proyectos de software porque:

-   Permite documentar de forma rápida y ordenada.
-   Es compatible con todos los sistemas operativos.
-   Se integra perfectamente con herramientas de control de versiones.
-   Es fácil de editar incluso desde un navegador.
-   No requiere programas especiales para visualizarse.
-   Es ideal para escribir documentación técnica, como:
    -   README
    -   Manuales
    -   Notas de desarrollo
    -   Especificaciones
...
La claridad y simplicidad del formato lo vuelven estándar en la
...
profesional.\
Al combinarse con GitHub, se convierte en el estándar para la
colaboración, el control de versiones y la creación de documentación
clara y accesible para todo el equipo.
